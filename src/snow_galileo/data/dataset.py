...
from snow_galileo.data.earthengine.esa_worldcover import NUM_WC_CLASSES, WC_CLASS_VALUES
from snow_galileo.data.utils import RunningStats
...
class Dataset(PyTorchDataset):
    ...
    def download_tifs_from_drive_folder():
        ...
        """
        SERVICE_ACCOUNT_FILE = Path(__file__).parents[3] / "ee-marlena-credentials.json"
