...
(:mod:`snow_galileo.data.local_sources.s1_snap`). This
...
from snow_galileo.data.local_sources._scene_ops import BandRead, cell_window, mosaic_tiles
...
class S1Adapter(LocalSourceAdapter):
    ...
    Reads the SNAP dB+angle cache (:mod:`snow_galileo.data.local_sources.s1_snap`), coalesces
