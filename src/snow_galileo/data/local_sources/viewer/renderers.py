...
from snow_galileo.data.local_sources.viewer.archives import (
    find_member,
    list_tar_members,
    list_zip_members,
    vsitar_path,
...
from snow_galileo.data.local_sources.viewer.quicklook import QuicklookResult, register
...
def render_cube_band(
    *, path: Path, var: str, timestep: int, is_static: bool, long_edge: int
    ...
    :func:`~snow_galileo.data.local_sources.viewer.outputs.band_index`).
    ...
    """
    from snow_galileo.data.local_sources.viewer.outputs import band_index
