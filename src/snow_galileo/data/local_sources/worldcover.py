...
onto the :class:`~snow_galileo.data.local_sources.base.GridCell`'s ``EPSG:32611`` (UTM 11N)
grid via the shared :func:`~snow_galileo.data.local_sources.base.reproject_to_cell`, so the
...
from snow_galileo.data.local_sources.base import GridCell, LocalSourceAdapter, reproject_to_cell
