...
10×10 FSC predictions to :class:`~snow_galileo.inference.mosaic.DailyMosaicWriter`.
...
through :func:`snow_galileo.inference._loader_bridge.masked_output_for_tif`, which calls
...
from snow_galileo.data.config import DAYS_PER_TIMESTEP, NUM_TIMESTEPS
