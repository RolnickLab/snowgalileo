...
from snow_galileo.data.dataset import Dataset as BaseDataset
from snow_galileo.data.dataset import DatasetOutput, Normalizer, to_cartesian
from snow_galileo.data.earthengine.eo_eval import (
    CLOUD_BANDS,
    EE_SPACE_BANDS,
    EE_WC_BANDS,
...
from snow_galileo.fsc.eval import EvalTask, model_class_name
from snow_galileo.fsc.metrics import compute_classification_metrics, compute_regression_metrics
from snow_galileo.fsc.patch_predict import (
    EncoderWithHead,
    evaluate_seg,
...
from snow_galileo.utils import DEFAULT_SEED, config_dir, device, masked_output_np_to_tensor
            ...
            for masked_output, filepath in tqdm(inference_dl, desc="Predicting output"):
                ...
                with cast(xr.Dataset, rioxarray.open_rasterio(filepath)) as data:
                    ...
                    new_attrs.update(
                        {
                            "description": (
                                "Input bands plus model prediction. The last band contains the pixel-wise "
                                ...
                                "2. Sentinel-2 (S2) bands: (B2, B3, B4, B8, B11, B12), "
                                "3. Landsat (LS) bands: (B2, B3, B4, B5, B6, B7), "
                                "4. Sentinel-3 (S3) bands: (Oa17_radiance, Oa21_radiance), "
                                "5. MODIS bands: (sur_refl_b01, sur_refl_b02, sur_refl_b03, sur_refl_b04, sur_refl_b05, sur_refl_b06, sur_refl_b07), "
                                "6. VIIRS bands: (I1, I3, M5, M7, M10, M11), "
                                "7. ERA5 bands (skin_temperature, temperature_2m, total_precipitation_sum, "
                                "u_component_of_wind_10m, v_component_of_wind_10m), "
                                "8. MODIS, Sentinel-2, and Landsat cloud flags (not used as model input, but included for reference), "
                                "Band number 305 to 308 (inclusive) contain the (static-over-time) topographic and land cover features used as model input (10 m resolution), "
                ...
                outfile = output_tif_folder / f"{filename}_with_preds.tif"
                new.rio.to_raster(outfile)
                ...
                band_descriptions = [
                    ...
                    "TS1 S2 B2", 
                    "TS1 S2 B3", 
                    "TS1 S2 B4", "TS1 S2 B8", "TS1 S2 B11", "TS1 S2 B12", "TS1 LS B2", "TS1 LS B3", "TS1 LS B4", "TS1 LS B5", "TS1 LS B6", "TS1 LS B7", "TS1 S3 Oa17_radiance", "TS1 S3 Oa21_radiance", "TS1 MODIS sur_refl_b01", "TS1 MODIS sur_refl_b02", "TS1 MODIS sur_refl_b03", "TS1 MODIS sur_refl_b04", "TS1 MODIS sur_refl_b05", "TS1 MODIS sur_refl_b06", "TS1 MODIS sur_refl_b07", "TS1 VIIRS I1", "TS1 VIIRS I3", "TS1 VIIRS M5", "TS1 VIIRS M7", "TS1 VIIRS M10", "TS1 VIIRS M11", "TS1 ERA5 skin_temperature", "TS1 ERA5 temperature_2m", "TS1 ERA5 total_precipitation_sum", "TS1 ERA5 u_component_of_wind_10m", "TS1 ERA5 v_component_of_wind_10m", "TS1 MODIS cloud_flag", "TS1 S2 cloud_flag", "TS1 LS cloud_flag", 
                    "TS2 S1 VV", "TS2 S1 VH", "TS2 S1 angle", "TS2 S2 B2", "TS2 S2 B3", "TS2 S2 B4", "TS2 S2 B8", "TS2 S2 B11", "TS2 S2 B12", "TS2 LS B2", "TS2 LS B3", "TS2 LS B4", "TS2 LS B5", "TS2 LS B6", "TS2 LS B7", "TS2 S3 Oa17_radiance", "TS2 S3 Oa21_radiance", "TS2 MODIS sur_refl_b01", "TS2 MODIS sur_refl_b02", "TS2 MODIS sur_refl_b03", "TS2 MODIS sur_refl_b04", "TS2 MODIS sur_refl_b05", "TS2 MODIS sur_refl_b06", "TS2 MODIS sur_refl_b07", "TS2 VIIRS I1", "TS2 VIIRS I3", "TS2 VIIRS M5", "TS2 VIIRS M7", "TS2 VIIRS M10", "TS2 VIIRS M11", "TS2 ERA5 skin_temperature", "TS2 ERA5 temperature_2m", "TS2 ERA5 total_precipitation_sum", "TS2 ERA5 u_component_of_wind_10m", "TS2 ERA5 v_component_of_wind_10m", "TS2 MODIS cloud_flag", "TS2 S2 cloud_flag", "TS2 LS cloud_flag",
                    "TS3 S1 VV", "TS3 S1 VH", "TS3 S1 angle", "TS3 S2 B2", "TS3 S2 B3", "TS3 S2 B4", "TS3 S2 B8", "TS3 S2 B11", "TS3 S2 B12", "TS3 LS B2", "TS3 LS B3", "TS3 LS B4", "TS3 LS B5", "TS3 LS B6", "TS3 LS B7", "TS3 S3 Oa17_radiance", "TS3 S3 Oa21_radiance", "TS3 MODIS sur_refl_b01", "TS3 MODIS sur_refl_b02", "TS3 MODIS sur_refl_b03", "TS3 MODIS sur_refl_b04", "TS3 MODIS sur_refl_b05", "TS3 MODIS sur_refl_b06", "TS3 MODIS sur_refl_b07", "TS3 VIIRS I1", "TS3 VIIRS I3", "TS3 VIIRS M5", "TS3 VIIRS M7", "TS3 VIIRS M10", "TS3 VIIRS M11", "TS3 ERA5 skin_temperature", "TS3 ERA5 temperature_2m", "TS3 ERA5 total_precipitation_sum", "TS3 ERA5 u_component_of_wind_10m", "TS3 ERA5 v_component_of_wind_10m", "TS3 MODIS cloud_flag", "TS3 S2 cloud_flag", "TS3 LS cloud_flag", 
                    "TS4 S1 VV", "TS4 S1 VH", "TS4 S1 angle", "TS4 S2 B2", "TS4 S2 B3", "TS4 S2 B4", "TS4 S2 B8", "TS4 S2 B11", "TS4 S2 B12", "TS4 LS B2", "TS4 LS B3", "TS4 LS B4", "TS4 LS B5", "TS4 LS B6", "TS4 LS B7", "TS4 S3 Oa17_radiance", "TS4 S3 Oa21_radiance", "TS4 MODIS sur_refl_b01", "TS4 MODIS sur_refl_b02", "TS4 MODIS sur_refl_b03", "TS4 MODIS sur_refl_b04", "TS4 MODIS sur_refl_b05", "TS4 MODIS sur_refl_b06", "TS4 MODIS sur_refl_b07", "TS4 VIIRS I1", "TS4 VIIRS I3", "TS4 VIIRS M5", "TS4 VIIRS M7", "TS4 VIIRS M10", "TS4 VIIRS M11", "TS4 ERA5 skin_temperature", "TS4 ERA5 temperature_2m", "TS4 ERA5 total_precipitation_sum", "TS4 ERA5 u_component_of_wind_10m", "TS4 ERA5 v_component_of_wind_10m", "TS4 MODIS cloud_flag", "TS4 S2 cloud_flag", "TS4 LS cloud_flag",
                    "TS5 S1 VV", "TS5 S1 VH", "TS5 S1 angle", "TS5 S2 B2", "TS5 S2 B3", "TS5 S2 B4", "TS5 S2 B8", "TS5 S2 B11", "TS5 S2 B12", "TS5 LS B2", "TS5 LS B3", "TS5 LS B4", "TS5 LS B5", "TS5 LS B6", "TS5 LS B7", "TS5 S3 Oa17_radiance", "TS5 S3 Oa21_radiance", "TS5 MODIS sur_refl_b01", "TS5 MODIS sur_refl_b02", "TS5 MODIS sur_refl_b03", "TS5 MODIS sur_refl_b04", "TS5 MODIS sur_refl_b05", "TS5 MODIS sur_refl_b06", "TS5 MODIS sur_refl_b07", "TS5 VIIRS I1", "TS5 VIIRS I3", "TS5 VIIRS M5", "TS5 VIIRS M7", "TS5 VIIRS M10", "TS5 VIIRS M11", "TS5 ERA5 skin_temperature", "TS5 ERA5 temperature_2m", "TS5 ERA5 total_precipitation_sum", "TS5 ERA5 u_component_of_wind_10m", "TS5 ERA5 v_component_of_wind_10m", "TS5 MODIS cloud_flag", "TS5 S2 cloud_flag", "TS5 LS cloud_flag",
                    "TS6 S1 VV", "TS6 S1 VH", "TS6 S1 angle", "TS6 S2 B2", "TS6 S2 B3", "TS6 S2 B4", "TS6 S2 B8", "TS6 S2 B11", "TS6 S2 B12", "TS6 LS B2", "TS6 LS B3", "TS6 LS B4", "TS6 LS B5", "TS6 LS B6", "TS6 LS B7", "TS6 S3 Oa17_radiance", "TS6 S3 Oa21_radiance", "TS6 MODIS sur_refl_b01", "TS6 MODIS sur_refl_b02", "TS6 MODIS sur_refl_b03", "TS6 MODIS sur_refl_b04", "TS6 MODIS sur_refl_b05", "TS6 MODIS sur_refl_b06", "TS6 MODIS sur_refl_b07", "TS6 VIIRS I1", "TS6 VIIRS I3", "TS6 VIIRS M5", "TS6 VIIRS M7", "TS6 VIIRS M10", "TS6 VIIRS M11", "TS6 ERA5 skin_temperature", "TS6 ERA5 temperature_2m", "TS6 ERA5 total_precipitation_sum", "TS6 ERA5 u_component_of_wind_10m", "TS6 ERA5 v_component_of_wind_10m", "TS6 MODIS cloud_flag", "TS6 S2 cloud_flag", "TS6 LS cloud_flag",
                    "TS7 S1 VV", "TS7 S1 VH", "TS7 S1 angle", "TS7 S2 B2", "TS7 S2 B3", "TS7 S2 B4", "TS7 S2 B8", "TS7 S2 B11", "TS7 S2 B12", "TS7 LS B2", "TS7 LS B3", "TS7 LS B4", "TS7 LS B5", "TS7 LS B6", "TS7 LS B7", "TS7 S3 Oa17_radiance", "TS7 S3 Oa21_radiance", "TS7 MODIS sur_refl_b01", "TS7 MODIS sur_refl_b02", "TS7 MODIS sur_refl_b03", "TS7 MODIS sur_refl_b04", "TS7 MODIS sur_refl_b05", "TS7 MODIS sur_refl_b06", "TS7 MODIS sur_refl_b07", "TS7 VIIRS I1", "TS7 VIIRS I3", "TS7 VIIRS M5", "TS7 VIIRS M7", "TS7 VIIRS M10", "TS7 VIIRS M11", "TS7 ERA5 skin_temperature", "TS7 ERA5 temperature_2m", "TS7 ERA5 total_precipitation_sum", "TS7 ERA5 u_component_of_wind_10m", "TS7 ERA5 v_component_of_wind_10m", "TS7 MODIS cloud_flag", "TS7 S2 cloud_flag", "TS7 LS cloud_flag",
                    "TS8 S1 VV", "TS8 S1 VH", "TS8 S1 angle", "TS8 S2 B2", "TS8 S2 B3", "TS8 S2 B4", "TS8 S2 B8", "TS8 S2 B11", "TS8 S2 B12", "TS8 LS B2", "TS8 LS B3", "TS8 LS B4", "TS8 LS B5", "TS8 LS B6", "TS8 LS B7", "TS8 S3 Oa17_radiance", "TS8 S3 Oa21_radiance", "TS8 MODIS sur_refl_b01", "TS8 MODIS sur_refl_b02", "TS8 MODIS sur_refl_b03", "TS8 MODIS sur_refl_b04", "TS8 MODIS sur_refl_b05", "TS8 MODIS sur_refl_b06", "TS8 MODIS sur_refl_b07", "TS8 VIIRS I1", "TS8 VIIRS I3", "TS8 VIIRS M5", "TS8 VIIRS M7", "TS8 VIIRS M10", "TS8 VIIRS M11", "TS8 ERA5 skin_temperature", "TS8 ERA5 temperature_2m", "TS8 ERA5 total_precipitation_sum", "TS8 ERA5 u_component_of_wind_10m", "TS8 ERA5 v_component_of_wind_10m", "TS8 MODIS cloud_flag", "TS8 S2 cloud_flag", "TS8 LS cloud_flag",
                    "elevation", "slope", "aspect", "ESA Worldcover Map", "SnowGalileo FSC prediction (value range 0-1)"
                ]
