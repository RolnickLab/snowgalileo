...
assert TIME_BANDS == S3_BANDS + MODIS_BANDS + VIIRS_FINE_BANDS + VIIRS_COARSE_BANDS + ERA5_BANDS
assert (
    TIME_SHIFT_VALUES
    == S3_SHIFT_VALUES
    + MODIS_SHIFT_VALUES
...
if MODALITIES["ndsi"].get("active"):
    ...
    TIME_SHIFT_VALUES_NP = np.append(TIME_SHIFT_VALUES_NP, [0])
    TIME_DIV_VALUES_NP = np.append(TIME_DIV_VALUES_NP, [1])
