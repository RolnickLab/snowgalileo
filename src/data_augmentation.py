...
class FlipAndRotateSpace(object):
    ...
    def apply(
        ...
        space_time_m_x = rearrange(space_time_m_x.float(), "b h w t c -> b t c h w")
        space_time_l_x = rearrange(space_time_l_x.float(), "b h w t c -> b t c h w")
        space_x = rearrange(space_x.float(), "b h w c -> b c h w")  # rearrange for transforms
        valid_data_mask_s_t_h = rearrange(valid_data_mask_s_t_h.float(), "b h w t c -> b t c h w")
        valid_data_mask_s_t_m = rearrange(valid_data_mask_s_t_m.float(), "b h w t c -> b t c h w")
        valid_data_mask_s_t_l = rearrange(valid_data_mask_s_t_l.float(), "b h w t c -> b t c h w")
        ...
        space_time_m_x = rearrange(transformation(space_time_m_x), "b t c h w -> b h w t c")
        space_time_l_x = rearrange(transformation(space_time_l_x), "b t c h w -> b h w t c")
        ...
        return (
            ...
            valid_data_mask_s_t_m.half(),
            valid_data_mask_s_t_l.half(),
