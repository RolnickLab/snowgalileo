...
LANDSAT_SPACE_TIME_BANDS = S1_BANDS + S2_BANDS + LANDSAT_BANDS + MODIS_CLOUD_FLAG_BANDS + VIIRS_CLOUD_FLAG_BANDS + S2_CLOUD_FLAG_BANDS + LANDSAT_CLOUD_FLAG_BANDS + NDVI_BANDS
...
LANDSAT_BANDS = LANDSAT_SPACE_TIME_BANDS + SPACE_TIME_BANDS_MED_RES + SPACE_TIME_BANDS_LOW_RES + LANDSAT_SPACE_BANDS + LANDSAT_TIME_BANDS + LANDSAT_STATIC_BANDS
