...
def subset_and_augment_batch_of_images(
    ...
    valid_data_mask_sp = valid_data_mask_sp[:, start_h : start_h + size, start_w : start_w + size]
    valid_data_mask_t = valid_data_mask_t[:, start_t : start_t + num_timesteps]
