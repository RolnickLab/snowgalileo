...
if args["checkpoint_name"] != "":
    ...
    model = EncoderWithHead(encoder_random_init, eval_config=default_attn_config, sigmoid_slope=default_attn_config["sigmoid_slope"]).to(device)
    ...
    if args["output_folder"] != "":
        ...
        model_debug = EncoderWithHead(encoder_pretrained, eval_config=default_attn_config, sigmoid_slope=default_attn_config["sigmoid_slope"]).to(device)
    ...
    model = EncoderWithHead(encoder, eval_config=default_attn_config, sigmoid_slope=default_attn_config["sigmoid_slope"]).to(device)
