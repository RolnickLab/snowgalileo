...
- **Source semantics (DATA_ANALYSIS.md §ERA5-Land + §Raw Archive Formats):**
  ...
  - Bands (in order): `skin_temperature, temperature_2m, total_precipitation_sum, u_component_of_wind_10m, v_component_of_wind_10m`.
...
2. Commit:
   ...
   ```
3. Check off subtasks/ACs. 5. Notify the user; request approval before TASK-009.
