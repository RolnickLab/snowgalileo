...
2. Commit:
   ...
   ```
3. Check off subtasks/ACs; note any unmet parity tolerances or the unset checkpoint (Q6).
4. Notify the user — this closes Phase 3. Surface remaining config-gated questions (Q3
