...
python export.py --mode "url" --start_export_from_idx 21000 --tifs_folder "tifs21000"
#python export.py --mode "url" --start_export_from_idx 22000 --tifs_folder "tifs21000"
#python export.py --mode "url" --start_export_from_idx 23000 --tifs_folder "tifs21000"