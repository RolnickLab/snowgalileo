...
python export.py --mode "url" --start_export_from_idx 51000 --tifs_folder "tifs51000"
#python export.py --mode "url" --start_export_from_idx 52000 --tifs_folder "tifs51000"
#python export.py --mode "url" --start_export_from_idx 53000 --tifs_folder "tifs51000"