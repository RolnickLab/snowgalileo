...
python export.py --mode "url" --start_export_from_idx 36000 --tifs_folder "tifs36000"
#python export.py --mode "url" --start_export_from_idx 37000 --tifs_folder "tifs36000"
#python export.py --mode "url" --start_export_from_idx 38000 --tifs_folder "tifs36000"