...
python export.py --mode "url" --start_export_from_idx 42000 --tifs_folder "tifs42000"
#python export.py --mode "url" --start_export_from_idx 43000 --tifs_folder "tifs42000"
#python export.py --mode "url" --start_export_from_idx 44000 --tifs_folder "tifs42000"