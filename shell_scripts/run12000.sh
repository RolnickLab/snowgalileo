...
python export.py --mode "url" --start_export_from_idx 12000 --tifs_folder "tifs12000"
#python export.py --mode "url" --start_export_from_idx 13000 --tifs_folder "tifs12000"
#python export.py --mode "url" --start_export_from_idx 14000 --tifs_folder "tifs12000"