...
python export.py --mode "url" --start_export_from_idx 39000 --tifs_folder "tifs39000"
#python export.py --mode "url" --start_export_from_idx 40000 --tifs_folder "tifs39000"
#python export.py --mode "url" --start_export_from_idx 41000 --tifs_folder "tifs39000"