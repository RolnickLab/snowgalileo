...
python export.py --mode "url" --start_export_from_idx 18000 --tifs_folder "tifs18000"
#python export.py --mode "url" --start_export_from_idx 19000 --tifs_folder "tifs18000"
#python export.py --mode "url" --start_export_from_idx 20000 --tifs_folder "tifs18000"