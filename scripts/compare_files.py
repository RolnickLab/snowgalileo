...
argparser.add_argument(
    "--input_folder", type=str, default="landsat_eval_tifs/patches_UTM_1_99_cropped"
)
argparser.add_argument(
    "--output_folder", type=str, default="landsat_eval_masks/all/patches_UTM_1_99_subset"
)
...
for file in input_path.glob("*.tif"):
    ...
    assert new_name == old_name, (
        f"Renaming would change the filename from {old_name} to {new_name}, which is not intended."
    )
    break
