...
from snow_galileo.fsc import CloudGeneratorEval, LandsatEval
...
argparser.add_argument(
    ...
    type=str,
    default="",
    help="Name of the checkpoint to be evaluated. Should be stored in the checkpoints_dir specified in src/snow_galileo/utils.py. If '', a randomly initialized model will be used.",
)
argparser.add_argument(
