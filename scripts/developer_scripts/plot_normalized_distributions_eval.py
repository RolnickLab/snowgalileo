...
if __name__ == "__main__":
    ...
    for i, (masked_output, labels, _) in enumerate(dataloader):
        ...
        t_x_c1_valid = t_x[..., -1, 1][valid_data_mask_t[..., -1, 1].bool()]
        t_x_c2_valid = t_x[..., -1, 2][valid_data_mask_t[..., -1, 2].bool()]
        t_x_c3_valid = t_x[..., -1, 3][valid_data_mask_t[..., -1, 3].bool()]
        t_x_c4_valid = t_x[..., -1, 4][valid_data_mask_t[..., -1, 4].bool()]
        t_x_c5_valid = t_x[..., -1, 5][valid_data_mask_t[..., -1, 5].bool()]
        t_x_c6_valid = t_x[..., -1, 6][valid_data_mask_t[..., -1, 6].bool()]
        t_x_c7_valid = t_x[..., -1, 7][valid_data_mask_t[..., -1, 7].bool()]
        t_x_c8_valid = t_x[..., -1, 8][valid_data_mask_t[..., -1, 8].bool()]
