...
if __name__ == "__main__":
    ...
    for i, (masked_output, labels, _) in enumerate(dataloader):
        ...
        t_x_c2_valid = t_x[..., 2][valid_data_mask_t[..., 1].bool()]
        t_x_c3_valid = t_x[..., 3][valid_data_mask_t[..., 2].bool()]
        t_x_c4_valid = t_x[..., 4][valid_data_mask_t[..., 3].bool()]
        t_x_c5_valid = t_x[..., 5][valid_data_mask_t[..., 3].bool()]
        t_x_c6_valid = t_x[..., 6][valid_data_mask_t[..., 3].bool()]
        t_x_c7_valid = t_x[..., 7][valid_data_mask_t[..., 3].bool()]
        t_x_c8_valid = t_x[..., 8][valid_data_mask_t[..., 3].bool()]
