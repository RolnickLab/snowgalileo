...
output_results_csv_path = RESULTS_FOLDER / f"evaluation_results_{args['results_csv_name']}_with_forest.csv"
output_results_csv_path.touch(exist_ok=True)

tif_data_path = DATA_FOLDER / data_config["input_tif_folder"] / "test"

cloud_dataset = ForestMetaDataset(data_folder=tif_data_path)
...
for i in all_files:
    ...
    fractional_forest_cover, filename = cloud_dataset.return_fractional_forest_cover_from_filename(i)
