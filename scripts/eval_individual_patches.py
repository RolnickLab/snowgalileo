...
argparser.add_argument(
    ...
    action="store_true",
    help="Whether to exclude input data from prediction date. Should match checkpoint training setup.",
)
argparser.add_argument(
...
argparser.add_argument(
    ...
    help="Config name for evaluation. Options are stored in config/eval/",
)
argparser.add_argument(
    "--h5pys_only",
    action="store_true",
