...
if __name__ == "__main__":
    ...
    for i, batch in enumerate(dataloader):
        ...
        sp_x_c4_valid = sp_x[..., 4][valid_data_mask_sp[..., 4].astype(bool)]
        sp_x_c5_valid = sp_x[..., 5][valid_data_mask_sp[..., 5].astype(bool)]
        sp_x_c6_valid = sp_x[..., 6][valid_data_mask_sp[..., 6].astype(bool)]
        sp_x_c7_valid = sp_x[..., 7][valid_data_mask_sp[..., 7].astype(bool)]
        sp_x_c8_valid = sp_x[..., 8][valid_data_mask_sp[..., 8].astype(bool)]
        sp_x_c9_valid = sp_x[..., 9][valid_data_mask_sp[..., 9].astype(bool)]
        sp_x_c10_valid = sp_x[..., 10][valid_data_mask_sp[..., 10].astype(bool)]
        sp_x_c11_valid = sp_x[..., 11][valid_data_mask_sp[..., 11].astype(bool)]
        sp_x_c12_valid = sp_x[..., 12][valid_data_mask_sp[..., 12].astype(bool)]
        sp_x_c13_valid = sp_x[..., 13][valid_data_mask_sp[..., 13].astype(bool)]
