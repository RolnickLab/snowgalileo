...
argparser.add_argument(
    ...
    help="Name of the checkpoint to be used for inference. Should be stored in the checkpoints_dir specified in src/utils.py. If '', a randomly initialized model will be used.",
)
argparser.add_argument(
