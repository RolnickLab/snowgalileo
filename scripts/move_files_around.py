...
argparser.add_argument("--src_folder_label", type=str, default="landsat_eval_masks/all/patches_UTM_1_99_test/test/")
argparser.add_argument("--dest_folder_label", type=str, default="landsat_eval_masks/all/patches_UTM_1_99_test/visualize/")
...
assert set(f.name for f in dest_folder_input.glob("*.tif")) == set(f.name for f in dest_folder_label.glob("*.tif"))
print(f"Copied {file_count} files from {src_folder_input} to {dest_folder_input} and from {src_folder_label} to {dest_folder_label}.")
