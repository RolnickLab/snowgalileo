...
def get_random_config():
    ...
    ### DATA and MASKING ###
    config["training"]["shape_time_combinations"] = [{"size": 4, "timesteps": 12}, {"size": 5, "timesteps": 6}, {"size": 6, "timesteps": 4}, {"size": 7, "timesteps": 3}, {"size": 9, "timesteps": 3}, {"size": 12, "timesteps": 3}]
    config["training"]["masking_probabilities"] = [0.3, 0.3, 0.3, 0.3, 0.8, 0.8, 0.6, 0.6, 0.6, 0.6, 0.3, 0.3, 0.3, 0.3, 0.5, 0.2, 0.2]
    config["training"]["unmasking_probabilities"] = [0.5, 0.8, 0.8, 0.6, 0.3, 0.3, 0.4, 0.4, 0.4, 0.4, 0.6, 0.6, 0.6, 0.6, 0.5, 0.8, 0.8]
